...
CREATE TABLE "ValueDetail" (
  ...
  "latestAt" timestamp WITHOUT time ZONE,
	...
	"daysMinTargetDelay" integer,
	"dateDaysMinTargetDelay" timestamp WITHOUT time ZONE,
	"daysMaxTargetDelay" integer,
	"dateDaysMaxTargetDelay" timestamp WITHOUT time ZONE,
	"daysLatestTargetDelay" integer,
	"dateDaysLatestTargetDelay" timestamp WITHOUT time ZONE
);
